...
with open("../kftt-data-1.0/data/orig/kyoto-dev.ja", "r") as fr_1:
    ja_sentences = fr_1.readlines()
    ja_sentences = [sentence[:len(sentence)-1] for sentence in ja_sentences]
    with open("../kftt-data-1.0/data/orig/kyoto-dev.en", "r") as fr_2:
        ...
        with open("encoded_ja_dev.txt", "wb") as fw_1:
            pickle.dump(short_encoded_ja_sentences, fw_1)

        with open("encoded_en_dev.txt", "wb") as fw_2:
