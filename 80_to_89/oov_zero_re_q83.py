        ...
        if epoch%(epoch_num//10) == (epoch_num//10)-1:
            ...
            for id in range(len(train_labels)):
                ...
                for j in range(len(train_converted_titles[id])):
                    if train_converted_titles[id][j] == 10387:
                        oov_counter += 1
            ...
            for id in range(len(test_labels)):
                ...
                for j in range(len(test_converted_titles[id])):
                    if test_converted_titles[id][j] == 10387:
                        oov_counter += 1
...
training_step(learning_rate = 0.2, epoch_num = 200, activation_function = "tanh", batch_shuffle = True) #500itでloss0.9 test accuracy:70%
